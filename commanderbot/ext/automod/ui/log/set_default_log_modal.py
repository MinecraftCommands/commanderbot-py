...
from discord import ChannelType, Interaction, TextStyle, ui

from commanderbot.ext.automod.automod_exceptions import CouldNotValidateLogChannel
...
class SetDefaultLogModal(CogStateModal["AutomodGuildState", AutomodStore]):
    def __init__(self, interaction: Interaction, state: AutomodGuildState):
        ...
        self.allowed_mentions_input.add_option(label="Everyone", default=False)
        self.allowed_mentions_input.add_option(label="Users", default=False)
        self.allowed_mentions_input.add_option(label="Roles", default=False)
        self.allowed_mentions_input.add_option(label="Replied User", default=False)
